...
class AMD:
    ...
    def process(self, hashmap, classify, colorize=None, merge=False, save=True, exit=True, logging=None, **kwargs):
        """
        ...
        logging : mlky.Sect, default=None
            Logging initialization options, needed for ray workers to log properly
        kwargs : dict
    ...
    def initLogging(self, logs=None):
        """
        Initializes the logger object

        Parameters
        ----------
        logs : mlky.Sect, default=None
